  ...
  array (
    ...
    array (
      ...
      array (
        'phase' => '01',
        'title' => 'Discover',
        'text' => 'Goals, users, constraints, and a realistic v1.',
      ),
      1 => 
      array (
        'phase' => '02',
        'title' => 'Plan',
        'text' => 'Milestones, design direction, and success criteria.',
      ),
      2 => 
      array (
        'phase' => '03',
        'title' => 'Build',
        'text' => 'Iterative delivery with demos every week.',
      ),
      3 => 
      array (
        'phase' => '04',
        'title' => 'Launch',
        'text' => 'Go live, hand over, and optionally keep improving.',
      ),
    ),
    'items' => 
    array (
