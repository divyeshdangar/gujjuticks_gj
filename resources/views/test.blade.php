...
<head>
    ...
    <style>
        @font-face {
            ...
            src: url('storage/font/InstrumentSerif.ttf');
        }
    </style>
...
<body>
    ...
    <script>
        window.addEventListener('load', function(event) {
            ...
            fabric.Image.fromURL('storage/images/dynamic/demo-user.jpg', function(img) {
                img.set({
                    left: 50,
                    top: 305,
                    angle: 0,
            ...
            fabric.Image.fromURL('storage/images/dynamic/logo_indiastic_white.png', function(img) {
                img.set({
                    left: 332,
                    top: 160,
                    angle: 0,
