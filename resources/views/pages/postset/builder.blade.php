            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="mt-5 mt-md-0">
                        <img src="{{ route('pages.image.postmain', ['slug' => $dataDetail->slug.'.jpg']) }}" alt=""
            ...
            <div class="row">
                <div class="col-lg-12 text-center mb-4">
                    <div class="section-title mb-5">
                        ...
                        <p class="text-muted">Explore a growing collection of creative posts covering history, culture, lifestyle, and more. Each set is uniquely crafted with engaging content and dynamic visuals, designed to inform, inspire, and spark curiosity. Dive into the stories that matter - one post at a time.</p>
                    </div>
                </div>
