            ...
            <div class="row align-items-center">
                <div class="col-lg-7">
                    <div class="mb-4 pb-3 me-lg-5">
                        ...
                        <h1 class="display-5 fw-semibold mb-3">{!! str_replace(
                            'GujjuTicks',
                            '<span class="text-warning fw-bold">GujjuTicks</span>',
                            $metaData['title'],
                        ) !!}</h1>
                    ...
                    <div class="row g-0">
                        <div class="col-md-4">
                            <div class="mt-3 mt-md-0 h-100">
                                <a class="btn btn-warning" href="#details" style="color: rgb(19, 19, 19) !important;">Start Reading</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="mt-5 mt-md-0">
                        <img loading="lazy" src="{{ URL::asset('/images/blog-category/' . $dataDetail->image) }}"
                            alt="{{ $dataDetail->title }} Image" title="{{ $dataDetail->title }} Image" class="home-img w-100 rounded-4" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="text-center">
                        <h2 class="text-warning mb-4">List of {{ $dataDetail->title }} Blogs</h2>
    ...
    <section class="section bg-light">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="text-center">
                        <h2 class="text-warning mb-4">Explore Our Other Blog Categories</h2>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12 text-muted">
                    <h2 class="text-warning text-center mb-4">More Details on {{ $dataDetail->title }}</h2>
