<x-layouts.dashboard :showHeader="true" :metaData="$metaData">
    ...
    <div class="card bg-white border-0 rounded-10 mb-4">
        <div class="card-body p-4">
            <h4 class="fw-semibold fs-18 border-bottom pb-20 mb-20">Edit Update Category</h4>
            ...
            <form method="post" action="{{ route('dashboard.update.category.edit.post', ['id' => $dataDetail->id]) }}">
                @csrf
                @include('dashboard.update-category.partials.form', ['dataDetail' => $dataDetail])
