<x-layouts.dashboard :showHeader="true" :metaData="$metaData">
    ...
    <div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
        <h3 class="mb-sm-0 mb-1 fs-18">{{ __('dashboard.pages') }}</h3>
        <ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
            ...
            <li>
                <span class="fw-semibold fs-14 heading-font text-dark dot ms-2">{{ __('dashboard.pages') }}</span>
            </li>
        </ul>
    </div>

    <form method="post" id="formToValidate" action="{{ route('dashboard.pages.edit.post', ['id' => $dataDetail->id]) }}">
        {{ csrf_field() }}
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card bg-white border-0 rounded-10 mb-4">
                    <div class="card-body p-4">
                        <h4 class="fw-semibold fs-18 border-bottom pb-20 mb-20">{{ __('dashboard.pages') }}</h4>
                        @if ($errors->any())
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <textarea id="meta_description" name="meta_description"
                                            ...
                                            placeholder="{{ __('dashboard.meta_description') }}" rows="3" rows="7">{{ old('meta_description', $dataDetail->meta_description) }}</textarea>
                                    </div>
    ...
    <script>
        ...
        function addCropperImage() {
            $image_crop = $('#upload-image-image').croppie({
                ...
                //url: '{{ URL::asset('/images/pages/' . $dataDetail->image) }}'
            });
