<x-layouts.dashboard :showHeader="true" :metaData="$metaData">
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card bg-white border-0 rounded-10 mb-4">
                <div class="card-body p-4">
                    ...
                    <form method="post" id="formToValidate" enctype="multipart/form-data" action="{{ route('dashboard.card.category.edit.post', ['id' => $dataDetail->id]) }}">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-lg-12">
        ...
        <div class="col-lg-4">
            <div class="card bg-white border-0 rounded-10 mb-4">
                <div class="card-body p-4">
                    <h4 class="fw-semibold fs-18 border-bottom pb-20 mb-20">{{ __('dashboard.card') }} {{ __('dashboard.image') }}</h4>
                    <img src="{{ URL::asset('/images/card-category/'.$dataDetail->image) }}" class="img-thumbnail">
                </div>
            </div>
        </div>
    </div>
