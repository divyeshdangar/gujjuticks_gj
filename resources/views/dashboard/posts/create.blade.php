<x-layouts.dashboard :showHeader="true" :metaData="$metaData">
    ...
    <form method="post" id="formToValidate" action="{{ route('dashboard.posts.edit.post', ['id' => 0]) }}">
        {{ csrf_field() }}
        <div class="row">
            <div class="col-md-12">
                                    ...
                                    <div class="form-group position-relative">
                                        <select class="form-select form-control ps-5 h-58" name="type" aria-label="Parent category selection" required>
                                            ...
                                            @foreach ($postTypes as $data)
                                                <option value="{{ $data }}" class="text-dark" @if ($data == old('type')) selected="selected" @endif>{{ $data }}</option>
                                            @endforeach
                                        </select>
                                        <i
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <textarea id="description" name="description"
                                            ...
                                            placeholder="{{ __('dashboard.description') }}" rows="3" rows="7">{{ old('description') }}</textarea>
                                    </div>
                                    @error('description')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <textarea id="description_g" name="description_g"
                                            ...
                                            placeholder="{{ __('dashboard.description') }}" rows="3" rows="7">{{ old('description_g') }}</textarea>
                                    </div>
                                    @error('description_g')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <textarea id="description_h" name="description_h"
                                            ...
                                            placeholder="{{ __('dashboard.description') }}" rows="3" rows="7">{{ old('description_h') }}</textarea>
                                    </div>
                                    @error('description_h')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <textarea id="extra" name="extra"
                                            ...
                                            placeholder="{{ __('dashboard.extra') }}" rows="3" rows="7">{{ old('extra') }}</textarea>
                                    </div>
                                    @error('extra')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
