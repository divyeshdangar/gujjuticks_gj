        ...
        <div class="col-lg-8">
            <div class="card bg-white border-0 rounded-10 mb-4">
                <div class="card-body p-4">
                    <h4 class="fw-semibold fs-18 border-bottom pb-20 mb-20">{{ __('dashboard.card') }} {{ __('dashboard.edit') }}</h4>
                    @if ($errors->any())
                    ...
                    <form method="post" id="formToValidate" enctype="multipart/form-data" action="{{ route('dashboard.card.edit.post', ['id' => '0']) }}">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-lg-12">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <input type="number" name="price" step="0.01" min="0" max="999999.99"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-4">
                                    <label class="label @error('slug') text-danger @enderror">{{ __('dashboard.front_image') }}</label>
                                    <input type="file" class="form-control h-58" id="front_image" name="front_image" accept="image/*">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group mb-4">
                                    <label class="label @error('slug') text-danger @enderror">{{ __('dashboard.back_image') }}</label>
