<x-layouts.dashboard :showHeader="true" :metaData="$metaData">
    ...
    <div class="card bg-white border-0 rounded-10 mb-4">
        <div class="card-body p-4">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end bg-white border box-shadow">
                        <li>
                            <a class="dropdown-item"
                                href="{{ route('dashboard.blog.category.edit', ['id' => $dataDetail->id]) }}">
            ...
            <div class="row">
                <div class="col-md-5">
                    <a target="_blank" href="{{ URL::asset('/images/blog-category/' . $dataDetail->image) }}">
                        <img src="{{ URL::asset('/images/blog-category/' . $dataDetail->image) }}" class="img-fluid rounded-10 mb-4">
                    </a>
                </div>
                <div class="col-md-7">
