    ...
    <div class="card bg-white border-0 rounded-10 mb-4">
        <div class="card-body p-4">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end bg-white border box-shadow">
                        <li>
                            <a class="dropdown-item"
                                href="{{ route('dashboard.location.edit', ['id' => $dataDetail->id]) }}">
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    <h4 class="fs-15 fw-semibold">{{ __('dashboard.name') }}:</h4>
                    <p class="mb-4">{!! $dataDetail->name !!} ({!! $dataDetail->name_gj !!})</p>
