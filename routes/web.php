...
Route::middleware([CheckLanguage::class])->group(function () {
    ...
    Route::get('update/{citySlug}/{postType}/{publicId}/edit', [UpdatesController::class, 'edit'])->name('pages.updates.edit');
    Route::post('update/{citySlug}/{postType}/{publicId}/edit', [UpdatesController::class, 'update'])->name('pages.updates.update');
    Route::post('update/{citySlug}/{postType}/{publicId}/delete', [UpdatesController::class, 'delete'])->name('pages.updates.delete');
    Route::post('update/{citySlug}/{postType}/{publicId}/comment', [UpdatesController::class, 'comment'])->name('pages.updates.comment.store');
    ...
    Route::post('update/{citySlug}/{postType}/{publicId}/react', [UpdatesController::class, 'react'])->name('pages.updates.react');
    Route::post('update/{citySlug}/{postType}/{publicId}/poll-vote', [UpdatesController::class, 'vote'])->name('pages.updates.poll.vote');
    Route::post('update/{citySlug}/{postType}/{publicId}/answer', [UpdatesController::class, 'answer'])->name('pages.updates.answer');
